...
engine/model). 9/12 verdicts expected-semantics-matched cleanly (plus 1 with an expected,
non-defect discrepancy), 3/12 (1, 3, 7, 10 minus overlap) carry a documented structural
